---
title: База знаний
description: 37+ заметок в формате Obsidian, документирующих паттерны, техники, источники, примеры, ссылки. Теоретический фундамент под каждым скилом.
---
...
> 37+ заметок, на которых стоят все рекомендации в 4 скилах. Откройте в [Obsidian](https://obsidian.md/) для полного граф-вью, либо читайте здесь.
